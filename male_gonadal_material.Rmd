...
## Load data
```{r}
G3_data <- Read10X_h5(filename = "/path/to/filtered_feature_bc_matrix.h5")
G4_data <- Read10X_h5(filename = "/path/to/filtered_feature_bc_matrix.h5")
```
...
cell_id2calledS <- read.table(file = "/path/to/gonads_cell_id2calledS.tsv",
                              header = TRUE, 
                              sep = "\t") # Cell ID to subject (donor) id assigned, using the Vireo
...
# Mesonephros
* Consists of 3 subjects, demultiplexed using SCSM + partly failed HTOs
